...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    metaDescription: "iPhone 電池健康度 80% 以下自動關機、續航大減？i時代認證電池與原廠電池雙選擇，板橋 30 分鐘完工。",
...
電池價格會隨零件行情調整，各機型的認證電池與原廠電池報價，請直接查詢站上每日更新的即時價格：

[👉 查詢你的機型換電池報價](/quote/apple)
...
換一次電池的費用，跟拆壞螢幕或主機板要付的代價相比，通常差很多。
...
`,
  ...
  },
  {
    ...
    metaDescription: "2026 年二手 iPhone 回收行情：各機型行情每日更新。i時代板橋江子翠現場估價。",
...
回收行情每日變動，實際金額依機況、配件完整度核定。最新價格請直接查詢：
...
`,
  ...
  },
  {
    ...
    metaDescription: "MacBook 電池膨脹處理：Air / Pro 全系列含 M1-M4，板橋專業維修，副廠認證電池價格實惠，當日完工，保固 6 個月。",
...
各機型的電池報價會隨零件行情調整，站上每日自動更新，請直接查詢即時價格：

[👉 查詢 MacBook 換電池報價](/quote/apple)

**報價全部含**：拆機、更換、重新貼合、測試、保固 6 個月，無額外工資。
...
`,
    faqs: [
      ...
      { q: "保固過了怎麼辦？", a: "過保後 Apple 官方維修約 $12,000-15,000。i時代副廠認證電池價格實惠，價格僅 1/3。" },
...
以 iPhone 螢幕破裂為例，各通路的差異不只在價格：

| 通路 | 零件來源 | 保固 | 工時 |
|---|---|---|---|
| **i時代** | 副廠認證 / 原廠雙選擇 | **3-6 個月** | 30-60 分鐘 |
| Apple 原廠 | 全新原廠 | 1 年 | 需預約 |
| 夜市維修店 | 品質不一 | 7-30 天 | 20 分鐘 |
| 網路寄送 | 看不到過程 | 視店家 | 2-7 天 |

**i時代的定位**：介於 Apple 原廠與夜市店之間，品質接近原廠、價格更親民、保固足夠。

各機型的實際維修報價每日更新，請直接查詢：[👉 查詢你的機型維修報價](/quote)
...
各機型的維修報價會隨零件行情調整，站上每日自動更新，請直接查詢即時價格：
...
`,
  ...
  },
  {
    ...
    metaDescription: "iPhone Face ID 失效原因、維修報價線上可查。i時代板橋專業 Face ID 排線維修，當日完工。",
...
`,
    faqs: [
      ...
      { q: "Apple 修 Face ID 多少錢？", a: "Apple 通常直接換整機，費用相當高。i時代只針對故障部位維修，費用低很多，實際報價可在維修報價頁查詢。" },
    ],
    relatedSlugs: ["iphone-12-touch-screen-issue"],
  },
  {
    ...
    metaDescription: "Switch 搖桿飄移專業維修，副廠磨菇頭價格實惠，板橋現場 30 分鐘完工，保固 3 個月。",
...
`,
    faqs: [
      ...
      { q: "iPad Pro 2018-2020 觸控門 Apple 還免費修嗎？", a: "原廠維修計畫已截止。i時代提供主機板觸控 IC 維修，比換新機便宜許多，實際報價可在維修報價頁查詢。" },
    ],
