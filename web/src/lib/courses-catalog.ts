...
export const COURSES: Course[] = [
  {
    ...
    includes: [
      "🛠️ 手機維修工具五件套（拆機刀、撥棒、吸盤、五星螺絲、十字螺絲）",
      "💻 電腦維修工具組（USB-C 測試器、萬用電表、防靜電墊）",
